...
SET @TableName = '[test].[dbo].[Migration$]'; --Your Table Name
SET @DateToUpdate = '[ Account Open Date ]'; --Your Date Column to Update
SET @New_Date = 'New_ACC'; --Your New Date Column Name
SET @CommonId = '[S#N]'; --Your Common Column (PK)
...
SET @sqlQuery = 'SELECT * FROM' + @TableName+';
				...
				--Update len having less then 8 to null
				UPDATE'+@TableName+'SET '+ @DateToUpdate+'  = null where '+@DateToUpdate+'  like ''%[a-z]%'';
				';
